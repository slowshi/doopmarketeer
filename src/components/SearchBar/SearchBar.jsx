...
import { searchTypes, palette, searchColors } from "../../utils/constants"
    ...
    <form className="w-100" onSubmit={handleSearchAddress}>
      <FormControl isInvalid={isError} mb="2">
        <InputGroup>
          ...
          <Input borderColor={searchColors[searchType].dark} focusBorderColor={searchColors[searchType].dark} _hover={{ borderColor: searchColors[searchType].light }} borderWidth='3px' backgroundColor="white" type="text" value={input} name={searchType} onChange={handleInputChange}
            placeholder={
              {
